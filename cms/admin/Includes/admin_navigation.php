        ...
        <ul class="nav navbar-nav side-nav">
            ...
            <li>
                ...
                <ul id="posts_dropdown" class="collapse">
                    <li>
                        <a href="admin_posts.php?source=default">View All Posts</a>
                    </li>
                    <li>
                        <a href="admin_posts.php?source=add_post">Add Post</a>
                    </li>
                </ul>
            </li> <!-- End Posts -->
            ...
            <!-- Categories -->
            <li class="active">
                <a href="./admin_categories.php"><i class="fa fa-fw fa-file"></i> Categories </a>
            </li>
